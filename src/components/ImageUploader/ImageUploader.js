...
import pipetteIcon from '../../image/pipette.png';
          ...
          {showColorPanel && (
            <div className="color-panel">
              <div className='panel-info'>
                <h3>Первый выбранный</h3>
                {color1 && (
                  <>
                    <div className="color-swatch" style={{ backgroundColor: color1.rgb }} />
                    <p>X x Y: {Math.round(color1.x)} x {Math.round(color1.y)}</p>
                    <p>RGB: {color1.rgb}</p>
              ...
              <div className='panel-info'>
                ...
                {color2 && (
                  <>
                    ...
                    <p>X x Y: {Math.round(color2.x)} x {Math.round(color2.y)}</p>
                    <p>RGB: {color2.rgb}</p>
